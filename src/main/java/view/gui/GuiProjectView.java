...
public class GuiProjectView extends JDialog implements IProjectView {
    ...
    private void setupListeners() {
        ...
        applyHandCursor(addTaskButton, editTaskButton, deleteTaskButton, backButton);
    }
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        backButton.setToolTipText("Voltar para a tela de projetos");
        ...
        editTaskButton.setToolTipText("Editar informações da tarefa");
        ...
        deleteTaskButton.setToolTipText("Excluir tarefa");
        ...
        addTaskButton.setToolTipText("Adicionar tarefa");
